const Hero = () => {
  return (
    <section id="home" className="relative h-[84vh] md:h-[92vh] w-full overflow-hidden">
      {/* Full-bleed photographic cover (no 3D) */}
      <img
        aria-hidden
        className="absolute inset-0 z-0 h-full w-full object-cover opacity-90"
        src="https://images.unsplash.com/photo-1501183638710-841dd1904471?q=80&w=2200&auto=format&fit=crop"
        alt="Luxury interior cover"
      />

      {/* Soft-light texture to blend with global facade */}
      <img
        aria-hidden
        ...
        alt="Skyscraper texture overlay"
        style={{ filter: 'grayscale(25%)' }}
      />

      {/* Neutral slate gradients (non-interactive) */}
      <div className="absolute inset-0 z-[2] pointer-events-none">
        <div className="absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-slate-950/85 via-slate-900/30 to-transparent" />
        ...
        <div className="mx-auto max-w-7xl px-6 h-full flex items-end md:items-center pb-20">
          <div className="text-white max-w-3xl">
            ...
            <p className="mt-3 text-sm sm:text-lg text-white/90">
              Curated luxury residences, builder floors, plots and farmhouses—guided by transparent, client‑first advisory.
            </p>
