...
const About = () => (
  <section id="about" className="py-16">
    <div className="mx-auto max-w-7xl px-6 grid md:grid-cols-2 gap-10">
      <div>
        <h2 className="text-3xl font-bold tracking-tight text-gray-900">About SheltOwn</h2>
        <p className="mt-3 text-gray-600">
          We are a Delhi NCR-focused real estate agency helping home buyers, sellers and investors discover exceptional opportunities across Gurgaon, Noida and South Delhi. With deep area expertise, strong developer network and a client-first approach, we ensure a transparent, seamless experience.
        </p>
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
          {[{
            ...
            <div key={i.title} className="rounded-lg border border-gray-200 p-4">
      ...
      <div className="rounded-xl overflow-hidden shadow bg-gradient-to-br from-indigo-50 to-white border border-indigo-100 p-6">
...
const Services = () => (
  <section id="services" className="py-16 bg-gray-50">
    <div className="mx-auto max-w-7xl px-6">
      ...
      <p className="mt-2 text-gray-600">Buy, sell, rent or invest with confidence. We tailor solutions to your goals.</p>
...
const Blog = () => (
  <section id="blog" className="py-16">
    <div className="mx-auto max-w-7xl px-6">
      <h2 className="text-3xl font-bold tracking-tight text-gray-900">Market Insights</h2>
      <p className="mt-2 text-gray-600">Tips and updates for buyers, sellers and investors in NCR.</p>
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          <a key={b.title} href="#" className="group rounded-xl overflow-hidden border bg-white border-gray-200 shadow-sm hover:shadow-md transition">
            <div className="h-44 w-full overflow-hidden">
              <img src={b.img} alt={b.title} className="h-full w-full object-cover group-hover:scale-105 transition-transform duration-300" />
            </div>
            <div className="p-4">
  ...
  <section id="contact" className="py-16 bg-gray-50">
    <div className="mx-auto max-w-7xl px-6 grid md:grid-cols-2 gap-10">
      <div>
        ...
        <p className="mt-2 text-gray-600">Visit our office or schedule a free consultation.</p>
...
export { About, Services, Blog, Contact, Testimonials };
